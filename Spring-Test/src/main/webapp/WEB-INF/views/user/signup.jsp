...
<body>
	...
	<div class="container">
	<form class="row g-3" action="/member/signup" id="form" method="post">
  <div class="col-md-6">
  ...
  <div class="col-12">
   ...
   <div class="col-12">
    ...
    <input type="text" class="form-control" name="home" placeholder="인천 남동구 어쩌구">
  </div>
  <div class="col-12">
...
<button type="submit" class="btn btn-outline-danger">Welcome</button>	
	</form>
	</div>
